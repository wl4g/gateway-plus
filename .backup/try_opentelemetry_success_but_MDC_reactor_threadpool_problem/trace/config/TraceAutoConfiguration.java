...
public class TraceAutoConfiguration {
    ...
    private BatchSpanProcessor buildBatchSpanProcessor(TraceProperties config, SpanExporter spanExporter) {
        // or see:io.opentelemetry.sdk.trace.export.SimpleSpanProcessor

        //
        // see:opentelemetry-1.14.0
        //
        ...
        //
        // see:opentelemetry-0.11.0
        //
        // return BatchSpanProcessor.builder(spanExporter)
        // .setMaxExportBatchSize(config.getBsp().getMaxExportBatchSize())
        // .setMaxQueueSize(config.getBsp().getMaxQueueSize())
        // .setScheduleDelayMillis(config.getBsp().getScheduleDelay())
        // .setExporterTimeoutMillis((int) config.getBsp().getExportTimeout())
        // .build();
    }
