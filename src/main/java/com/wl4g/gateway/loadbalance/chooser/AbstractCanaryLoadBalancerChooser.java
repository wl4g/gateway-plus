...
import static com.wl4g.gateway.loadbalance.config.CanaryLoadbalanceAutoConfiguration.BEAN_CANARY_LB_REQUEST_MATCHER;
...
public abstract class AbstractCanaryLoadBalancerChooser implements CanaryLoadBalancerChooser {
    ...
    protected @Autowired GatewayPlusMetricsFacade metricsFacade;
