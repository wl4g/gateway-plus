...
public abstract class IamGatewayUtil {
    ...
    public static abstract class SafeFilterOrdered extends EnvironmentUtil {
        ...
        public static final int ORDER_IPFILTER = getIntProperty("GW_ORDER_IPFILTER", -100);

        public static final int ORDER_REQUEST_SIZE = getIntProperty("GW_ORDER_REQUEST_SIZE", -90);

        public static final int ORDER_FAULT = getIntProperty("GW_ORDER_FAULT", -80);

        public static final int ORDER_SIMPLE_SIGN = getIntProperty("GW_ORDER_SIMPLE_SIGN", -70);

        public static final int ORDER_TRACE = getIntProperty("GW_ORDER_TRACE", -60);

        /**
         * Depends: traceId, principal(optional, The dyeing print according to
         * principal log)
         */
        public static final int ORDER_LOGGING = getIntProperty("GW_ORDER_LOGGING", -50);

        /**
         * Depends: principal(request limit by principal)
         */
        public static final int ORDER_REQUEST_LIMITER = getIntProperty("GW_ORDER_REQUEST_LIMITER", -40);

        public static final int ORDER_TRAFFIC_REPLICATION = getIntProperty("GW_ORDER_TRAFFIC_REPLICATION", -30);

        public static final int ORDER_RESPONSE_CACHE = getIntProperty("GW_ORDER_RESPONSE_CACHE", -20);

        public static final int ORDER_RETRY = getIntProperty("GW_ORDER_RETRY", -10);
        ...
        public static final int ORDER_CIRCUITBREAKER = getIntProperty("GW_ORDER_CIRCUITBREAKER", 1000);
         ...
         */
        public static final int ORDER_CANARY_LOADBALANCER = getIntProperty("GW_ORDER_CANARY_LOADBALANCER",
                RouteToRequestUrlFilter.ROUTE_TO_URL_FILTER_ORDER + 149);

        public static final int ORDER_HTTPS_TO_HTTP = getIntProperty("GW_ORDER_HTTPS_TO_HTTP", ORDER_CANARY_LOADBALANCER + 10);
