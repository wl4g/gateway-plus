...
import com.wl4g.gateway.ipfilter.config.IpFilterProperties.StrategyProperties;
...
public class IpSubnetFilterFactory extends AbstractGatewayFilterFactory<IpSubnetFilterFactory.Config> {
    ...
    public IpSubnetFilterFactory(IpFilterProperties ipListConfig, GatewayPlusMetricsFacade metricsFacade) {
