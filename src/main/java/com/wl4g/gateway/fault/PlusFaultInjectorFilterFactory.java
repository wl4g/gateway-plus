 ...
 */
package com.wl4g.gateway.fault;
...
import com.wl4g.gateway.fault.config.FaultProperties;
import com.wl4g.gateway.fault.config.FaultProperties.AbstractInjectorProperties;
import com.wl4g.gateway.fault.config.FaultProperties.InjectorProperties;
import com.wl4g.gateway.fault.config.FaultProperties.InjectorProvider;
...
public class PlusFaultInjectorFilterFactory extends AbstractGatewayFilterFactory<PlusFaultInjectorFilterFactory.Config> {
    ...
    public PlusFaultInjectorFilterFactory(FaultProperties faultConfig, GatewayPlusMetricsFacade metricsFacade) {
        super(PlusFaultInjectorFilterFactory.Config.class);
    ...
    private void applyDefaultToConfig(Config config) {
        try {
            ConfigBeanUtils.configureWithDefault(new PlusFaultInjectorFilterFactory.Config(), config, faultConfig.getDefaultInject());
    ...
    public static final String BEAN_NAME = "PlusFaultInjector";
