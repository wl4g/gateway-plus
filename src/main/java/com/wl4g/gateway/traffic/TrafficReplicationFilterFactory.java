 ...
 */
package com.wl4g.gateway.traffic;
...
import com.wl4g.gateway.traffic.config.TrafficProperties;
import com.wl4g.gateway.traffic.config.TrafficProperties.ReplicationProperties;
import com.wl4g.gateway.util.IamGatewayUtil;
import com.wl4g.gateway.util.http.ReactiveHttpClientBuilder;
...
public class TrafficReplicationFilterFactory extends AbstractGatewayFilterFactory<TrafficReplicationFilterFactory.Config> {
    ...
    class TrafficReplicationGatewayFilter implements GatewayFilter {
         ...
         * 
         * @see {@link com.wl4g.gateway.logging.RequestLoggingGlobalFilter#decorateRequest()}
