...
package com.wl4g.gateway.retry;
...
public class PlusRetryGatewayFilterFactory extends AbstractGatewayFilterFactory<PlusRetryGatewayFilterFactory.RetryConfig> {
    ...
    private static final Log log = LogFactory.getLog(PlusRetryGatewayFilterFactory.class);

    public PlusRetryGatewayFilterFactory() {
    ...
    public GatewayFilter apply(RetryConfig retryConfig) {
        ...
        return new GatewayFilter() {
            ...
            public String toString() {
                return filterToStringCreator(PlusRetryGatewayFilterFactory.this).append("retries", retryConfig.getRetries())
    ...
    public GatewayFilter apply(String routeId, Repeat<ServerWebExchange> repeat, Retry<ServerWebExchange> retry) {
        ...
        // publisher = ((Mono<Void>)
        // publisher).retryWhen(retry.withApplicationContext(exchange));
        // }
        // if (repeat != null) {
        // // repeatWhen returns a Flux<Void>
        // // so this needs to be last and the variable a Publisher<Void>
        // publisher = ((Mono<Void>)
        // publisher).repeatWhen(repeat.withApplicationContext(exchange));
        // }
        //
        ...
        //
        return new PlusRetryGatewayFailter(routeId, repeat, retry);
        //
    ...
    @AllArgsConstructor
    class PlusRetryGatewayFailter implements GatewayFilter, Ordered {

        private final String routeId;
        private final Repeat<ServerWebExchange> repeat;
        private final Retry<ServerWebExchange> retry;
    ...
    public static final String BEAN_NAME = "PlusRetry";
