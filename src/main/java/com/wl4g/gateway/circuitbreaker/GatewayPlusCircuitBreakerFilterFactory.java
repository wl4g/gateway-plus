...
public abstract class GatewayPlusCircuitBreakerFilterFactory
        extends AbstractGatewayFilterFactory<GatewayPlusCircuitBreakerFilterFactory.Config> {

    /** CircuitBreaker component name. */
    public static final String NAME = "PlusCircuitBreaker";
    ...
    public GatewayPlusCircuitBreakerFilterFactory(ReactiveCircuitBreakerFactory reactiveCircuitBreakerFactory,
    ...
    public GatewayFilter apply(Config config) {
        ...
        // return
        // filterToStringCreator(SpringCloudCircuitBreakerFilterFactory.this).append("name",
        // config.getName())
    ...
    class IamSpringCloudCircuitBreakerGatewayFilter implements GatewayFilter, Ordered {
        ...
        @Override
        public String toString() {
            return filterToStringCreator(GatewayPlusCircuitBreakerFilterFactory.this).append("name", config.getName())
                                                                                     .append("fallback", config.fallbackUri)
                                                                                     .toString();
        }
