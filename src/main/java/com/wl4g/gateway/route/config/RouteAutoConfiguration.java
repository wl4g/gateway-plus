...
import com.wl4g.gateway.route.RefreshRouteApplicationListener;
import com.wl4g.gateway.route.TimeBasedRouteRefresher;
...
public class RouteAutoConfiguration {
    ...
    @Bean
    @ConfigurationProperties(prefix = GatewayPlusConstants.CONF_PREFIX_ROUTE)
