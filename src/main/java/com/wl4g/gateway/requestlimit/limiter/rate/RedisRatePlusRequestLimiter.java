...
import com.wl4g.gateway.requestlimit.config.PlusRequestLimiterProperties.LimiterProperties.RedisRateLimiterProperties;
import com.wl4g.gateway.requestlimit.configurer.LimiterStrategyConfigurer;
import com.wl4g.gateway.requestlimit.event.RateLimitHitEvent;
...
@Getter
@Setter
public class RedisRatePlusRequestLimiter extends AbstractRedisPlusRequestLimiter<RedisRateRequestLimiterStrategy> {

    private final RedisScript<List<Long>> redisScript;

    public RedisRatePlusRequestLimiter(RedisScript<List<Long>> redisScript, PlusRequestLimiterProperties requestLimiterConfig,
                ...
                .flatMap(strategy -> {
                    ...
                    try {
                        ...
                        return redisTemplate.execute(redisScript, keys, scriptArgs)
                                // .log("redisRatePlusRequestLimiter",
                                // Level.FINER);
