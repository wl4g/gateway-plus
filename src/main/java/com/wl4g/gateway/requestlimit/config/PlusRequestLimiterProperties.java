...
import static com.wl4g.gateway.constant.GatewayPlusConstants.CACHE_PREFIX_REQUESTLIMIT_CONF_QUOTA;
import static com.wl4g.gateway.constant.GatewayPlusConstants.CACHE_PREFIX_REQUESTLIMIT_CONF_RATE;
import static com.wl4g.gateway.constant.GatewayPlusConstants.CACHE_PREFIX_REQUESTLIMIT_EVENT_HITS_QUOTA;
import static com.wl4g.gateway.constant.GatewayPlusConstants.CACHE_PREFIX_REQUESTLIMIT_EVENT_HITS_RATE;
import static com.wl4g.gateway.constant.GatewayPlusConstants.CACHE_PREFIX_REQUESTLIMIT_TOKEN_QUOTA;
import static com.wl4g.gateway.constant.GatewayPlusConstants.CACHE_PREFIX_REQUESTLIMIT_TOKEN_RATE;
...
@ToString
@Validated
public class PlusRequestLimiterProperties {
    ...
    public static class LimiterProperties {
        ...
        public static class RedisRateLimiterProperties extends AbstractLimiterProperties {
             ...
             */
            private String configPrefix = CACHE_PREFIX_REQUESTLIMIT_CONF_RATE;

            /**
             * Redis tokens rate limiter user-level token computational key
             * prefix.
             */
            private String tokenPrefix = CACHE_PREFIX_REQUESTLIMIT_TOKEN_RATE;
        ...
        public static class RedisQuotaLimiterProperties extends AbstractLimiterProperties {
             ...
             */
            private String configPrefix = CACHE_PREFIX_REQUESTLIMIT_CONF_QUOTA;

            /**
             * The quota limiter user-level tokens computational key prefix.
             */
            private String tokenPrefix = CACHE_PREFIX_REQUESTLIMIT_TOKEN_QUOTA;
    ...
    public static class EventRecorderProperties {
        ...
        public static class RedisLimitEventRecorderProperties {
             ...
             */
            private String rateHitsCumulatorPrefix = CACHE_PREFIX_REQUESTLIMIT_EVENT_HITS_RATE;

            /**
             * Event logging key prefix for redis based quota limiter
             */
            private String quotaHitsCumulatorPrefix = CACHE_PREFIX_REQUESTLIMIT_EVENT_HITS_QUOTA;
