...
import static com.wl4g.gateway.constant.GatewayPlusConstants.CACHE_SUFFIX_IAM_GATEWAY_RESPONSECACHE;
...
public class ResponseCacheProperties {
    ...
    public static String RESPONSE_CACHED_HEADER = "X-Escg-Cached";
}
